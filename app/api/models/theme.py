...
def get_theme(name: ThemeName | str) -> Theme:
    ...
    if name == ThemeName.REMINDERS_NOTEBOOK:
        return Theme(
            name=name,
            paper_width_px=base_paper,
            outer_margin=18,
    ...
    return get_theme(ThemeName.REMINDERS_NOTEBOOK)
